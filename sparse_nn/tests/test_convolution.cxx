...
int main()
{
    ...
    Array<double> output_image = convolution_layer(image);
    Array<double> output_image_forward = convolution_layer.Forward(image);  
    ...
    Array<double> output_image_forward2 = convolution_layer_padding_stride.Forward(image);// = symbol is not defined
